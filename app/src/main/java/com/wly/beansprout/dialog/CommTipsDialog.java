...
public class CommTipsDialog extends AlertDialog implements View.OnClickListener {
    ...
    public CommTipsDialog(Context context, String title, String content, ItemClick popupClick) {
    ...
    public CommTipsDialog(Context context, String title, String content, boolean hideCancel, ItemClick popupClick) {
        super(context, R.style.weicomeDialog);
        this.popupClick = popupClick;
        this.title = title;
        this.content = content;
