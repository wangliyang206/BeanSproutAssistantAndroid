...
public class PrivacyPolicyDialog extends AlertDialog implements View.OnClickListener {
    ...
    public PrivacyPolicyDialog(Context context, int theme, ItemClick popupClick) {
        super(context, theme);
    ...
    private void initView() {
        ...
        agreement.setSpan(new MyClickableSpan("《服务协议》"), 24, 30, SpannableString.SPAN_INCLUSIVE_INCLUSIVE);
        agreement.setSpan(new MyClickableSpan("《隐私政策》"), 31, 37, SpannableString.SPAN_INCLUSIVE_INCLUSIVE);
