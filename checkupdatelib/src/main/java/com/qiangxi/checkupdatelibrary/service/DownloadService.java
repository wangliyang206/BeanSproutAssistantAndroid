...
public class DownloadService extends Service implements DownloadCallback {
    ...
    public void checkUpdateFailure(Throwable t) {
        ...
        startService(intent);
        Log.e("DownloadService","失败原因："+t.getMessage());
        mNotificationUtil.showDownloadFailureNotification(this, intent, mOption.getNotificationIconResId(),
    ...
    public void downloadProgress(long currentLength, long totalLength) {
        mNotificationUtil.showDownloadingNotification(this, (int) currentLength, (int) totalLength,
    ...
    public void downloadSuccess(File apk) {
        ...
        mNotificationUtil.showDownloadSuccessNotification(this, apk, mOption.getNotificationIconResId(),
